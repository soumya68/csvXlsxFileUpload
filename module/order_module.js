...
module.exports = function () {
    var orderModule = {
        ...
        createOrder: function (productDetails, finalPrice,
            userId,
            redeemedPoints,
            pointSource, countryCode, availablePoints, callBack) {
            try {
                ...
                if (
                    parseFloat(finalPrice) >= parseFloat(pointDetails[countryCode].orderTotalPrice)) {
                ...
                if (redeemedPoints > 0) {
                    ...
                    totalAvailablePoints = parseFloat(availablePoints) - parseFloat(redeemedPoints)
                }
                var orderData = {
                    userId: userId,
